...
public final class CameraManager {
  ...
  /**
   * Convenience method for {@link org.rcredits.zxing.client.android.CaptureActivity}
   */
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      // cgf (fails in portrait) framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
      framingRect = new Rect(0, 0, screenResolution.x, screenResolution.y); // cgf rectangle is whole screen
